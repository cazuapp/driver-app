...
import 'package:cazuapp/components/iconextended.dart';
...
class StorePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocProvider(
        create: (_) =>
            UserInfoBloc(instance: BlocProvider.of<AuthenticationBloc>(context).instance)..add(const LoadBase()),
    ...
    return BlocBuilder<UserInfoBloc, UserInfoState>(builder: (context, state) {
      switch (state.current) {
        ...
        case UserStatus.failure:
          return const FailurePage(title: "Store", subtitle: "Error");
        case UserStatus.success:
          break;
      }

      /* We retrieve global settings to display them */
      ...
      return Scaffold(
          ...
          appBar: const TopBar(title: "Store"),
          body: SafeArea(
              child: SizedBox(
                  height: size.height,
                  child: Padding(
                            ...
                            Expanded(
                                ...
                                child: Container(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ItemExtended(input: "Store", title: name, fawesome: FontAwesomeIcons.store),
                                          IconExtended(
                                            input: "Store status",
                                            title: Etc.fromstring(current!) == 1 ? "Accepting orders" : "Store closed",
                                          ...
                                          ItemExtended(
                                              input: "Email",
                                              title: context.select((AuthenticationBloc bloc) =>
                                                  bloc.instance.settings.getValue(key: 'contact')),
                                          ...
                                          ItemExtended(
                                              ...
                                              onTap: () => {Etc.launchPhone(dest: phone)},
                                              iconsrc: Icons.phone_enabled),
                                          url!.isNotEmpty
                                              ? ItemExtended(
                                                  external: true,
                                                  input: "Website",
                                                  onTap: () => {Etc.launchURL(base: url, dest: '')},
                                                  title: context.select((AuthenticationBloc bloc) =>
                                          ...
                                          instagram!.isNotEmpty
                                              ? ItemExtended(
                                                  ...
                                                  input: "Instagram",
                                                  onTap: () => {
                                                        Etc.launchURL(base: "http://www.instagram.com", dest: instagram)
                                                      },
                                                  title: instagram,
                                          ...
                                          twitter!.isNotEmpty
                                              ? ItemExtended(
                                                  ...
                                                  input: "Twitter",
                                                  onTap: () =>
                                                      {Etc.launchURL(base: "http://www.twitter.com", dest: twitter)},
                                                  title: twitter,
                                          ...
                                          facebook!.isNotEmpty
                                              ? ItemExtended(
                                                  ...
                                                  input: "Facebook",
                                                  onTap: () =>
                                                      {Etc.launchURL(base: "http://www.facebook.com", dest: facebook)},
                                                  title: facebook,
