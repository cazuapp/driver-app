...
class OrderAssignAction extends OrderManagerEvent {
  const OrderAssignAction({required this.id, required this.action});
...
class SetAux extends OrderManagerEvent {
  const SetAux({required this.value});

  final CurrentStatus value;
...
class SetStatus extends OrderManagerEvent {
  const SetStatus({required this.id, required this.action});

  final int id;
  final CurrentStatus action;
